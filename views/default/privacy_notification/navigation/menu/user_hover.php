...
if (PrivacyNotificationOptions::anonymizeUser($user) && !elgg_is_admin_logged_in()) {
    $notice = elgg_format_element('li', ['class' => 'pn_user_notice'], elgg_echo('privacy_notification:anonymize:user:note'));
    echo elgg_format_element('ul', ['class' => 'elgg-menu elgg-menu-hover'], $notice);
    return;
}
